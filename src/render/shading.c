...
t_color3 ft_bdrf(t_hit_point hpt, t_vec3 light_dir, t_color3 light_color)
{
	...
	return ft_vec3_scal_prod(light_color, intensity);
}
...
t_color3 ft_get_shade(t_hit_point hpt)
{
	...
	// diffuse = light * ration * (light dir dot prod)
	// Final color = ambiant + diffuse * object
	...
	// (void) final_color; return spec_light;
	return (final_color);
}
